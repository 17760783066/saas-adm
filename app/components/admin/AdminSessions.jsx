...
export default class AdminSessions extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            merchantAdminId: this.props.merchantAdminId,
    ...
    loadData = () => {
        ...
        let { merchantAdminId, pagination = {} } = this.state;

        App.api('merchant/adm/merchantAdmin_sessions', {
            merchantAdminSessionQo: JSON.stringify({
                merchantAdminId,
