import { message } from '_antd@4.19.2@antd';
...
var U = (function () {
    ...
    let getIdFromUrl = () => {
        let _id = U.getParameter('id');
        if (U.str.isEmpty(_id)) {
            message.error('参数错误');
            return;
        }
        return U.base64.decode(_id.toString());
    };
    ...
    let base64 = (() => {
        ...
        let decode = (str) => {
            return base64decode(str).toString();
        };

        return { getBlobBydataURI, toFile, encode, encodeUtf8,decode };
    })();
    ...
    return {
        ...
        base64, toFixed, num,getIdFromUrl
    };
})();
